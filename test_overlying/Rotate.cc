...
int Rotate::init()
{
    ...
    float vertices[] = {
    //    ---- 位置 ----           - 纹理坐标 -
        1.5f,  1.5f, -1.0f,     1.0f, 0.0f,   // 右上角
        1.5f, -1.5f, -1.0f,     1.0f, 1.0f,   // 右下角
        -1.5f, -1.5f, -1.0f,    0.0f, 1.0f,   // 左下角
        -1.5f,  1.5f, -1.0f,    0.0f, 0.0f    // 左上角
    };
...
int Rotate::draw()
{
    // glm::mat4 trans = glm::mat4(1.0f); //初始化为一个单位矩阵
